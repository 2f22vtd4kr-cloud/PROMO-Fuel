    ...
    <>
      ...
      <div className="tab-content" style={{ height: "100%", overflowY: "auto", WebkitOverflowScrolling: "touch", backgroundImage: 'radial-gradient(ellipse 100% 50% at 50% 0%, rgba(26,34,53,0.8) 0%, transparent 60%)' }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 14, paddingBottom: "24px" }}>
          ...
          {/* Welcome header */}
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", position: 'sticky', top: 0, zIndex: 50, background: 'linear-gradient(to bottom, rgba(6,8,16,0.95) 0%, transparent 100%)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', padding: "14px 14px 10px", paddingRight: 120 }}>
            <div>
