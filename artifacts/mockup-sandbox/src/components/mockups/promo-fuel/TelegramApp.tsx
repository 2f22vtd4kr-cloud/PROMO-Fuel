...
function MeshBg() {
  return (
    <div style={{ position: "absolute", inset: 0, overflow: "hidden", pointerEvents: "none" }}>
      ...
      `}</style>
      {/* Orb 1 — green (savings/fuel theme) */}
      <div style={{
      ...
      {/* Orb 3 — orange (fuel/energy theme) */}
      <div style={{
...
function HomeTab() {
  ...
  const featuredPromos = [
    {
      title: "АЗС Газпром нефть",
      desc: "Скидка -5₽/л на АИ-92, 95",
      color: TG.blue,
      glow: TG.blueGlow,
      badge: "ТОП",
      claimed: 1847,
    ...
    {
      title: "Лукойл — Кэшбэк 8%",
      desc: "При оплате картой от 40л",
      color: TG.green,
      glow: TG.greenGlow,
      badge: "АКТИВНА",
      claimed: 934,
    ...
    {
      title: "Shell: 2 бак = бесплатно",
      desc: "Промо-код FUEL2025 до 31.07",
      color: TG.orange,
      glow: TG.orangeGlow,
      badge: "НОВАЯ",
      claimed: 221,
              ...
              <div style={{ display:"flex", alignItems:"flex-start", justifyContent:"space-between", marginBottom:10 }}>
                ...
                <div style={{ display:"flex", gap:6 }}>
                  {c.status === "running" && (
                    <div style={{
                      width:28, height:28, borderRadius:9,
                      background:`${TG.green}18`, border:`1px solid ${TG.green}35`,
                      display:"flex", alignItems:"center", justifyContent:"center",
                    }}>
                  ...
                  {c.status === "paused" && (
                    <div style={{
                      width:28, height:28, borderRadius:9,
                      background:`${TG.blue}18`, border:`1px solid ${TG.blue}35`,
                      display:"flex", alignItems:"center", justifyContent:"center",
                    }}>
...
// ════════════════════════════════════════════════════════════════════════════
// TAB: ACCOUNTS (Telegram Sender Accounts)
// ════════════════════════════════════════════════════════════════════════════
              ...
              <div>
                ...
                <div style={{ height:3, borderRadius:2, background:"rgba(255,255,255,0.07)" }}>
                  <div style={{
                    ...
                    boxShadow:pct > 0 ? `0 0 6px ${acc.color}66` : "none",
                  }} />
                </div>
              </div>
            </GlassCard>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ fontSize:14, fontWeight:700, color:TG.text }}>9:41</span>
          <div style={{
            width:120, height:30, borderRadius:20,
            background:"rgba(0,0,0,0.6)",
          }} />
          <div style={{ display:"flex", gap:5, alignItems:"center" }}>
            <div style={{ width:14, height:8, borderRadius:2, border:`1.5px solid ${TG.text}`, position:"relative" }}>
              <div style={{ position:"absolute", left:1, top:1, bottom:1, width:"70%", background:TG.green, borderRadius:1 }} />
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display:"flex", alignItems:"center", gap:8 }}>
            <div style={{
              ...
              background:"linear-gradient(145deg,#ff9f4040 0%,#2de89730 100%)",
              border:"1px solid rgba(255,159,64,0.4)",
              display:"flex", alignItems:"center", justifyContent:"center",
            }}>
              <Fuel size={16} color={TG.orange} />
            </div>
            <div>
              <div style={{ fontSize:14, fontWeight:800, color:TG.text }}>PROMO-Fuel</div>
              <div style={{ fontSize:9, color:TG.muted }}>Телеграм МиниАпп</div>
            </div>
          </div>
          <GlassCard style={{ padding:"6px 10px", borderRadius:12, cursor:"pointer" }}>
            <Settings size={14} color={TG.muted} />
          </GlassCard>
        </div>
